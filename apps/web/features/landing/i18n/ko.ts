      ...
      entries: [
        {
          version: "0.3.14",
          date: "2026-06-02",
          title: "일본어 지원, 스킬 바로 선택, 워크스페이스 로고",
          changes: [],
          features: [
            "Multica가 앱, 웹사이트, 문서에서 일본어를 지원하며, 일본어 설정, 문서 검색, 일본어에 맞는 글꼴 표시도 제공합니다.",
            "채팅에서 슬래시 메뉴로 에이전트의 스킬을 선택할 수 있어, 정확한 스킬 이름을 외우지 않아도 작업 의도를 더 쉽게 전달할 수 있습니다.",
            "워크스페이스에 사용자 지정 로고를 설정할 수 있고, 내비게이션, 설정, breadcrumb, 온보딩 화면에 표시됩니다.",
            "CLI나 API에서 기존 스킬 목록을 덮어쓰지 않고 에이전트에 스킬을 추가할 수 있습니다.",
            "OpenCode 에이전트에서 thinking variant를 선택하고, 실행에도 선택한 값을 반영할 수 있습니다.",
          ],
          improvements: [
