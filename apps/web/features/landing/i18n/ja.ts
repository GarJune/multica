      ...
      entries: [
        {
          version: "0.3.14",
          date: "2026-06-02",
          title: "日本語対応、スキルのショートカット、ワークスペースロゴ",
          changes: [],
          features: [
            "Multica がアプリ、ウェブサイト、ドキュメントで日本語に対応し、日本語設定、ドキュメント検索、日本語に適したフォント表示も利用できます。",
            "チャットでスラッシュメニューからエージェントのスキルを選べるようになり、正確なスキル名を覚えていなくても作業の意図を伝えやすくなりました。",
            "ワークスペースに独自のロゴを設定でき、ナビゲーション、設定、パンくず、オンボーディングで表示されます。",
            "CLI や API から、既存のスキル一覧を置き換えずにエージェントへスキルを追加できます。",
            "OpenCode エージェントで思考の強さのバリエーションを選び、実行時にもその選択を反映できます。",
          ],
          improvements: [
